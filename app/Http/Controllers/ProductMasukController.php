...
class ProductMasukController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $product->save();
        $value_id_in = DB::table('product_masuk')->latest('id')->first();
        $value_id_out = DB::table('product_keluar')->latest('id')->first();
        DB::table('finances')
        ->insert([
            'product_id' => $request->product_id,
            'id_product_in' => $value_id_in->id,
            'id_product_out' => $value_id_out->id
