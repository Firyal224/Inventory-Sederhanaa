...
Route::group(['middleware' => 'auth'], function () {
	...
	Route::get('/financeDatatable', 'FinanceController@data_table')->name('api.financeDatatable');
	Route::get('/exportLaporanAllExcel', 'FinanceController@exportExcel')->name('exportExcel.LaporanAll');
